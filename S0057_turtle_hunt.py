...
CAUGHT_DISTANCE = 20  # Hunt is over, when a hunter is nearer to the prey than that. In competition: probably 10.

random.seed()  # use seed() if you want reproducible random numbers for debugging purposes
