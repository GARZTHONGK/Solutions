...
button_1 = tk.Button(main_window, text="Click me, I am a very long long button", activebackground="#ff00e6", bd="5px")
button_2 = tk.Button(main_window, text="Another very cool button", activebackground="#0011ff", bd="30px")
# activeforeground is the color of the text
