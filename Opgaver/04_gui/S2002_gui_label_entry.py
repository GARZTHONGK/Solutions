...
label_2 = tk.Label(main_window, text="This is another label")

label_1.grid(row=2, column=3)
label_2.grid(row=5, column=2)
# Create an entry
...
entry_2 = tk.Entry(main_window, width=48, justify="center")
entry_2.grid(row=5, column=2)
entry_2.insert(0, "wda")
